...
{
    public class EnemyController_Patrol : EnemyController_ymkim50
    {
        #region Variables
        ...
        protected override void Start()
        {
            ...
            stateMachine = new StateMachine_ymkim50<EnemyController_ymkim50>(this, new MoveToWaypointState_ymkim50());
